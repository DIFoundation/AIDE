...
import {ShieldAlert, Lock, Mail, ArrowRight, AlertCircle, User,} from "lucide-react";
...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen bg-dark-bg flex flex-col justify-center items-center px-6 py-12">
      {/* Brand Identity */}
